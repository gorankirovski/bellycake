...
export const updateProfile = (userData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(`${URL_API}/api/v1/me/update`, userData, config);
...
export const updatePassword = (passwords) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(
      `${URL_API}/api/v1/password/update`,
      passwords,
      config
    );
...
export const forgotPassword = (email) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(`${URL_API}/api/v1/password/forgot`, email, config);
...
export const resetPassword = (token, passwords) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(
      `${URL_API}/api/v1/password/reset/${token}`,
      passwords,
      config
    );
